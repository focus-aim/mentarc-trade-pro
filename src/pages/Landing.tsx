    ...
    <div className="min-h-screen bg-white text-[hsl(220,20%,14%)] overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-[hsl(220,15%,94%)]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center">
          ...
          <div className="hidden md:flex items-center gap-2 ml-12 text-sm text-[hsl(220,10%,35%)]">
            <button
              onClick={() => navigate("/updates")}
              className="px-4 py-1.5 rounded-full hover:text-[hsl(217,100%,50%)] hover:bg-[hsl(220,15%,96%)] transition-colors"
            >
              产品动态
            </button>
            <button
